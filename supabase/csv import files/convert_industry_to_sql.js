...
const csvPath = 'supabase/csv import files/industry_directory-export-2026-05-25_13-58-59.csv';
const sqlPath = 'supabase/csv import files/industry_directory_insert.sql';
...
for (let i = 1; i < rawLines.length; i++) {
  ...
  const sql = `INSERT INTO public.industry_directory (${colList})\nVALUES (${valList})\nON CONFLICT (id) DO UPDATE SET ${updateStr};\n`;
