      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 relative">
          <div className="h-2 rounded-full bg-[hsl(0,0%,88%)]">
            <motion.div
              className="h-full rounded-full bg-[hsl(158,17%,37%)]"
              initial={{ width: 0 }}
          ...
          {MILESTONES.map((m) => (
            <div
              ...
              className={`absolute top-1/2 -translate-y-1/2 w-3 h-3 rounded-full border-2 transition-colors ${
                progress >= m
                  ? "bg-[hsl(158,17%,37%)] border-[hsl(158,17%,37%)]"
                  : "bg-[hsl(60,14%,98%)] border-[hsl(0,0%,78%)]"
              }`}
        ...
        {showRewardHint && progress < 90 && (
          <div className="flex items-center gap-1 text-xs text-[hsl(45,80%,45%)] font-body font-medium">
            <Gift size={14} />
