...
import { X, UploadCloud, Send, Check, AlertTriangle, Trash2, Image } from 'lucide-react';
...
const WriteForMyRaahaModal = ({ isOpen, onClose }: WriteForMyRaahaModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 1. Upload Cover Image to Supabase Storage if present
      if (coverImage) {
      ...
      // 2. Insert Article Details to Supabase Database
  ...
  // Always call createPortal — control visibility via CSS/conditional inside
  return createPortal(
    isOpen ? (
      <div className="write-modal-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
              ...
              <form className="write-modal-form" onSubmit={handleSubmit}>
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <input 
                      type="text" 
                      placeholder="e.g. The Future of AI in Career Navigation" 
                      value={title}
                ...
                <div className="form-row">
                  ...
                  <div className="form-group">
                    ...
                    <input 
                      type="text" 
                      placeholder="e.g. UX Designer / Educator" 
                      value={authorTitle}
                ...
                <div className="form-group">
                  ...
                  >
                    {imagePreview ? (
                      <div className="premium-preview-container" style={{
                        width: '100%',
                        height: '160px',
                        display: 'flex',
                        alignItems: 'center',
                        ...
                        padding: '1rem',
                        background: '#f8fafc',
                        border: '2px dashed var(--myraaha-blue)',
                        borderRadius: '12px'
                      }}>
