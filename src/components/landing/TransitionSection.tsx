  ...
  return (
    <section ref={ref} className="py-28 md:py-36 bg-muted/20 relative overflow-hidden">
      <div className="absolute top-12 right-6 md:right-12">
        <span className="font-display text-[120px] md:text-[180px] text-muted/30 leading-none select-none">08</span>
      </div>
            ...
            <div className="lg:col-span-3 space-y-3">
              {features.map((f, i) => (
                <motion.div
                  ...
                  className="flex items-start gap-5 bg-card rounded-2xl p-5 border border-border shadow-soft hover:shadow-card transition-shadow duration-300 group"
                >
                  <div className="flex flex-col items-center gap-1 shrink-0">
                    <div className="w-11 h-11 rounded-xl gradient-warm flex items-center justify-center group-hover:scale-110 transition-transform">
                      <f.icon size={20} className="text-primary-foreground" />
                    </div>
                    <span className="font-display text-[10px] text-muted-foreground">{f.num}</span>
                  </div>
                  <div>
