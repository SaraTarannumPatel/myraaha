...
import { ArrowRight, TrendingUp, BookOpen, Target, PenTool } from "lucide-react";
      ...
      <section className="insights-featured">
        <div className="featured-card">
          ...
          <div className="featured-content">
            ...
            <h2>
              The Career Guidance Gap: Why India's Navigation System is Structurally <span>Broken</span>
            </h2>
            <p>{featuredPost.excerpt}</p>
            <Link to={`/insights/${featuredPost.slug}`} className="btn-partner read-article-btn">
              Read full analysis
            </Link>
          </div>
        </div>
