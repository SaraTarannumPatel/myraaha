...
const MyRaahaInsightsDetail = () => {
    ...
    const loadPost = async () => {
      ...
      if (slug && slug.startsWith("community-")) {
        try {
          ...
          const { data: rawData, error } = await (supabase as any).from("public_insights").select("*").eq("id", dbId).single();
  ...
  if (isLoading) {
    return (
      <div
        className="insights-detail-loading"
        style={{
          minHeight: "60vh",
          display: "flex",
          alignItems: "center",
      ...
      >
        <div
          ...
          style={{
            ...
            borderTop: "3px solid var(--myraaha-blue)",
            borderRadius: "50%",
  ...
  const relatedPosts =
    post.relatedReadingSlugs && post.relatedReadingSlugs.length > 0
          ...
          <aside className="insight-sidebar">
            <div className="insight-sticky-widgets">
              ...
              <div className="insight-widget insight-cta-widget">
                ...
                <form
                  className="insight-sidebar-form"
                  onSubmit={(e) => {
                    e.preventDefault();
                    alert("Subscribed to Insights newsletter!");
                  }}
                >
                  <input type="email" placeholder="Your email address" required className="insight-input-email" />
                  <button type="submit" className="insight-btn-subscribe">
                    Subscribe
                  </button>
                </form>
              </div>
        ...
        <div className="insight-author-card-full">
          <div className="insight-author-card-content">
            ...
            <div className="insight-author-bio">
              ...
              <p>
                Exploring the future of career transition, scaling mentorship ecosystems, and bridging the vocational
                skills gap in India. Dedicated to delivering data-driven solutions for builders and professionals.
              </p>
