  ...
  const faqs = [
    {
      ...
      answer:
        "MyRaaha is an empathetic navigation system designed to scale career and entrepreneurship guidance through data-driven insights.",
    },
    {
      question: "Who can benefit from <span>MyRaaha?</span>",
      answer:
        "Students, early professionals, and aspiring founders seeking structural clarity and localized guidance across Bharat.",
    },
    {
      question: "Is the platform <span>free?</span>",
      answer:
        "We are non-profit by intent and revenue-first by design, ensuring accessibility for all while maintaining institutional sustainability.",
    },
  ];
        ...
        <div className="v4-container">
          <div className="contact-v4-grid">
            ...
            <div className="v4-form-card">
              {status === "success" ? (
                <div
                  className="v4-success-container"
                  style={{
                    display: "flex",
                ...
                >
                  <div
                    className="v4-success-icon-wrapper"
                    style={{
                      width: "80px",
                      height: "80px",
                      borderRadius: "50%",
                  ...
                  <p
                    style={{
                      fontSize: "1.1rem",
                      color: "var(--myraaha-text-gray)",
                      maxWidth: "400px",
                      lineHeight: "1.6",
                      marginBottom: "2rem",
                    }}
                  >
                    Thank you for reaching out. We have logged your request in our system and our team will get back to
                    you shortly.
                  </p>
                  <button
              ...
              <div className="context-card">
                ...
                <div className="context-content">
                  <div className="social-strip">
                    <a
                      href="https://www.linkedin.com/company/myraaha/about"
                      target="_blank"
                    ...
                    <a
                      href="https://www.instagram.com/myraaha"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="social-item social-icon-btn"
                    >
                      <Instagram />
                    </a>
                    <a
                      href="https://x.com/myraahaorg"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="social-item social-icon-btn"
                    >
                    ...
                    <a
                      href="https://www.facebook.com/people/MyRaaha-Foundation/61589707157375/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="social-item social-icon-btn"
                    >
                    ...
                    <a href="mailto:contact@myraaha.org" className="social-item social-icon-btn" aria-label="Mail">
                      <Mail />
                    </a>
                  </div>
                </div>
