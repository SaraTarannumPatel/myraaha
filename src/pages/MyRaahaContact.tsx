...
const MyRaahaContact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    } catch (err_err) { const err = err_err as any;
  ...
  const faqs = [
    {
      question: "What is <span>MyRaaha?</span>",
      answer: "MyRaaha is an empathetic navigation system designed to scale career and entrepreneurship guidance through data-driven insights."
    },
    {
      question: "Who can benefit from <span>MyRaaha?</span>",
      answer: "Students, early professionals, and aspiring founders seeking structural clarity and localized guidance across Bharat."
    },
    {
      question: "Is the platform <span>free?</span>",
      answer: "We are non-profit by intent and revenue-first by design, ensuring accessibility for all while maintaining institutional sustainability."
    }
  ];
        ...
        <div className="v4-container">
          <div className="contact-v4-grid">
            ...
            <div className="v4-form-card">
              {status === 'success' ? (
                <div className="v4-success-container" style={{
                  display: 'flex',
                  ...
                  <div className="v4-success-icon-wrapper" style={{
                    width: '80px',
                    height: '80px',
                    borderRadius: '50%',
                    background: '#ecfdf5',
                    ...
                    <CheckCircle size={44} className="text-emerald-500" style={{ color: '#10b981' }} />
                  </div>
                  <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'var(--myraaha-text-dark)', marginBottom: '1rem' }}>
                    Message <span>Received!</span>
                  </h2>
                  <p style={{ fontSize: '1.1rem', color: 'var(--myraaha-text-gray)', maxWidth: '400px', lineHeight: '1.6', marginBottom: '2rem' }}>
                    Thank you for reaching out. We have logged your request in our system and our team will get back to you shortly.
                  </p>
                  <button 
                    onClick={() => setStatus('idle')} 
                    className="btn-primary v4-submit-btn" 
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="v4-contact-form">
                    ...
                    {status === 'error' && (
                      <div className="v4-error-msg" style={{
                        display: 'flex',
                        alignItems: 'center',
                        gap: '0.5rem',
                        color: '#dc2626',
            ...
            <div className="v4-context-col">
              ...
              <div className="context-card">
                ...
                <div className="context-content">
                  <a href="mailto:contact@myraaha.org" className="context-pill">
                    contact@myraaha.org
                  </a>
                  <a href="tel:+916360287699" className="context-pill">
                    +91 63602 87699
                  </a>
                </div>
              </div>
              ...
              <div className="context-card">
                ...
                <div className="context-content">
                  <div className="social-strip">
                    ...
                    <a href="https://www.instagram.com/myraaha" target="_blank" rel="noopener noreferrer" className="social-item social-icon-btn"><Instagram /></a>
                    <a href="https://x.com/myraahaorg" target="_blank" rel="noopener noreferrer" className="social-item social-icon-btn"><Twitter /></a>
                    <a href="https://www.facebook.com/people/MyRaaha-Foundation/61589707157375/" target="_blank" rel="noopener noreferrer" className="social-item social-icon-btn"><Facebook /></a>
                    <a href="mailto:contact@myraaha.org" className="social-item social-icon-btn" aria-label="Mail"><Mail /></a>
                  </div>
                </div>
              </div>
