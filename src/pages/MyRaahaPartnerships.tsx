      ...
      <section className="partnerships-engagement-v2">
        ...
        <div className="engagement-path-container">
          ...
          <div className="path-step-v2 left">
            ...
            <div className="path-card-v2">
              <div className="path-card-header">
                <div className="path-icon-box"><Search /></div>
          ...
          <div className="path-step-v2 right">
            ...
            <div className="path-card-v2">
              <div className="path-card-header">
                <div className="path-icon-box"><MessageSquare /></div>
                <h3>Proposal & need <span>discussion</span></h3>
              </div>
          ...
          <div className="path-step-v2 left">
            ...
            <div className="path-card-v2">
              <div className="path-card-header">
                ...
                <h3>Service <span>selection</span></h3>
              </div>
          ...
          <div className="path-step-v2 right">
            ...
            <div className="path-card-v2">
              <div className="path-card-header">
                <div className="path-icon-box"><Zap /></div>
                <h3>Service <span>introduction</span></h3>
              </div>
