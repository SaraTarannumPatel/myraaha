...
import { Users, Star, Zap, MapPin, Clock, ArrowRight, Shield, Heart, Globe } from 'lucide-react';
          ...
          <div className="role-split-container">
            <div className="role-split-text">
              ...
              <p className="role-section-subtitle">
                ...
                You'll have the radical autonomy to lead initiatives that bridge the gap for millions 
                across India. We believe that the best products are built by those who are 
                deeply aligned with the human purpose behind the code.
              </p>
            </div>
        ...
        <div className="role-container">
          ...
          <div className="perks-grid">
            <div className="perk-card">
              <div className="perk-icon"><Shield /></div>
              <h3>Strategic <span>Ownership</span></h3>
              <p>Directly influence our product roadmap and lead cross-functional initiatives from day one.</p>
            </div>
            <div className="perk-card">
              <div className="perk-icon"><Zap /></div>
              <h3>Accelerated <span>Growth</span></h3>
              <p>Work at the cutting edge of AI and social tech in a high-velocity startup environment.</p>
            </div>
            <div className="perk-card">
              <div className="perk-icon"><Heart /></div>
              <h3>Mission <span>Alignment</span></h3>
              <p>Wake up every day knowing your work contributes to a more equitable and guided world.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="role-container">
          ...
          <div className="faq-grid">
            <div className="faq-card">
              <h3>What is the work <span>culture</span> like?</h3>
              <p>We are hybrid-first and value deep work. We believe in radical autonomy and trust our team to manage their own time and results.</p>
            </div>
            <div className="faq-card">
              <h3>Are there opportunities for <span>remote work?</span></h3>
              <p>Yes, many of our core team roles are remote-friendly, though we do have hubs in major cities for collaborative sessions.</p>
            </div>
            <div className="faq-card">
              <h3>How is MyRaaha <span>structured?</span></h3>
              <p>We are non-profit by intent and revenue-first by design. This means we focus deeply on social impact and equity, while maintaining a product-driven, self-sustaining operational framework.</p>
            </div>
            <div className="faq-card">
              <h3>What candidate <span>backgrounds</span> do you value?</h3>
              <p>We prioritize high agency, deep domain expertise, and a genuine passion for systemic social equity. We look for individuals who can build scalable, tech-first products and systems.</p>
            </div>
          </div>
        </div>
      </section>
