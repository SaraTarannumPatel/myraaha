...
import { Rocket, Smile, MapPin, Clock, ArrowRight, Users } from 'lucide-react';
  ...
  return (
    <div className="role-page">
      ...
      <StandardPageHero
        ...
        title={<>Launch Your <span>Career</span></>}
          ...
          <div className="role-split-container reversed">
            <div className="role-split-text">
              ...
              <p className="role-section-subtitle">
                Our internship program is designed to be a definitive career launchpad. You'll be treated as a full team member
                with the autonomy to make a mark. We provide the mentorship, but you provide the momentum.
              </p>
            </div>
      ...
      <section className="role-section role-alt-bg">
        <div className="role-container">
          ...
          <div className="perks-grid">
            <div className="perk-card"><div className="perk-icon"><Rocket /></div><h3>Hands-on <span>Building</span></h3><p>Work on live projects that reach thousands of students. No "shadowing"—you build and ship.</p></div>
            <div className="perk-card"><div className="perk-icon"><Users /></div><h3>Expert <span>Mentorship</span></h3><p>Weekly 1-on-1s with founders and leads to guide your growth and professional narrative.</p></div>
            <div className="perk-card"><div className="perk-icon"><Smile /></div><h3>Pathway to <span>Core</span></h3><p>Top-performing interns are frequently offered full-time roles or long-term partnerships.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="role-section role-alt-bg">
        <div className="role-container">
          ...
          <div className="faq-grid">
            <div className="faq-card"><h3>Is this a <span>paid</span> internship?</h3><p>Yes, all our internships are paid with a competitive stipend based on your skills and contribution.</p></div>
            <div className="faq-card"><h3>What are the working hours?</h3><p>We are flexible! Most interns work 20-30 hours a week, allowing you to balance work with your studies.</p></div>
            <div className="faq-card"><h3>What is the <span>mentorship</span> structure like?</h3><p>Every intern is paired with a core team mentor for weekly 1-on-1s. You'll also participate in strategy reviews with leadership.</p></div>
            <div className="faq-card"><h3>Do interns work on <span>live production</span> code?</h3><p>Absolutely! You will build and ship features, systems, or campaigns that serve real students across Bharat.</p></div>
          </div>
        </div>
      </section>
