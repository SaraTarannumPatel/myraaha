...
import { Heart, MapPin, Clock, ArrowRight, Users, Star } from 'lucide-react';
  ...
  return (
    <div className="role-page">
      ...
      <StandardPageHero
        ...
        title={<>Empower Through <span>Contribution</span></>}
          ...
          <div className="role-split-container reversed">
            <div className="role-split-text">
              ...
              <p className="role-section-subtitle">
                Volunteering at MyRaaha is about radical empathy. You'll contribute to initiatives that provide direct
                clarity to those who need it most, bridging the gap between potential and opportunity in rural India.
              </p>
            </div>
      ...
      <section className="role-section role-alt-bg">
        <div className="role-container">
          ...
          <div className="perks-grid">
            <div className="perk-card"><div className="perk-icon"><Heart /></div><h3>Direct Social <span>Impact</span></h3><p>See firsthand how your contribution helps a student navigate their career and life choices.</p></div>
            <div className="perk-card"><div className="perk-icon"><Users /></div><h3>Global <span>Network</span></h3><p>Join a network of individuals dedicated to systemic change and educational equity.</p></div>
            <div className="perk-card"><div className="perk-icon"><Star /></div><h3>Mission <span>Certification</span></h3><p>Receive formal recognition and recommendations for your contribution to our social mission.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="role-section role-alt-bg">
        <div className="role-container">
          ...
          <div className="faq-grid">
            <div className="faq-card"><h3>Who can <span>volunteer?</span></h3><p>Anyone with a passion for education and helping others! We have roles for students, professionals, and retirees alike.</p></div>
            <div className="faq-card"><h3>Is there a <span>minimum</span> commitment?</h3><p>It varies by role. Some require just a couple of hours a week, while others are project-based.</p></div>
            <div className="faq-card"><h3>Can I volunteer <span>remotely?</span></h3><p>Yes, absolutely! The vast majority of our volunteering programs are hybrid or fully remote.</p></div>
            <div className="faq-card"><h3>What kind of <span>projects</span> will I support?</h3><p>Regional community translation, mentoring local students, supporting offline workshops, and grass-roots outreach campaigns.</p></div>
          </div>
        </div>
      </section>
...
export default CareerVolunteer;
