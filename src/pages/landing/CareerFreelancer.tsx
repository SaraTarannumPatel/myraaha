...
import { Clock, Zap, Layers, MapPin } from 'lucide-react';
  ...
  return (
    <div className="role-page">
      ...
      <StandardPageHero
        ...
        title={<>Scale with <span className="italic">Specialized Skills</span></>}
          ...
          <div className="role-split-container">
            <div className="role-split-text">
              ...
              <p className="role-section-subtitle">
                We value specialized mastery. As a freelancer at MyRaaha, you'll tackle clear challenges with creative
                freedom and zero administrative friction. We provide the context, you provide the craft.
              </p>
            </div>
      ...
      <section className="role-section role-alt-bg">
        <div className="role-container">
          ...
          <div className="perks-grid">
            <div className="perk-card"><div className="perk-icon"><Clock /></div><h3>True <span>Autonomy</span></h3><p>Work on your own terms. We prioritize high-quality outcomes over rigid desk hours.</p></div>
            <div className="perk-card"><div className="perk-icon"><Zap /></div><h3>High <span>Velocity</span></h3><p>Focus on your craft. We provide clear briefs and direct access to stakeholders for fast execution.</p></div>
            <div className="perk-card"><div className="perk-icon"><Layers /></div><h3>Specialized <span>Impact</span></h3><p>Apply your niche skills to critical product milestones that move the needle for our users.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="role-section role-alt-bg">
        <div className="role-container">
          ...
          <div className="faq-grid">
            <div className="faq-card"><h3>How does payment work?</h3><p>We work on a milestone-based payment structure. Payments are released promptly upon completion of project stages.</p></div>
            <div className="faq-card"><h3>Can I work with other clients?</h3><p>Absolutely. We respect your autonomy. As long as our project goals are met, you're free to manage your portfolio.</p></div>
          </div>
        </div>
      </section>
...
export default CareerFreelancer;
