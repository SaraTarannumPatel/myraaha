...
import { Lightbulb, Target, MapPin, Clock, ArrowRight, Award } from 'lucide-react';
  ...
  return (
    <div className="role-page">
      ...
      <StandardPageHero
        ...
        title={<>Shape the <span>Next Generation</span></>}
          ...
          <div className="role-split-container">
            <div className="role-split-text">
              ...
              <p className="role-section-subtitle">
                Our facilitators are the catalysts for growth. You'll bridge the gap between potential and success in our
                incubation and guidance programs, mentoring the next wave of founders.
              </p>
            </div>
      ...
      <section className="role-section role-alt-bg">
        <div className="role-container">
          ...
          <div className="perks-grid">
            <div className="perk-card"><div className="perk-icon"><Lightbulb /></div><h3>Thought <span>Leadership</span></h3><p>Share your mastery and build your personal brand as a leading voice in innovation and education.</p></div>
            <div className="perk-card"><div className="perk-icon"><Target /></div><h3>Strategic <span>Mentorship</span></h3><p>Directly influence the trajectory of early-stage startups and student-led social ventures.</p></div>
            <div className="perk-card"><div className="perk-icon"><Award /></div><h3>Curated <span>Network</span></h3><p>Connect with a high-caliber community of investors, founders, and industry-leading experts.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="role-section role-alt-bg">
        <div className="role-container">
          ...
          <div className="faq-grid">
            <div className="faq-card"><h3>What experience is <span>required?</span></h3><p>We look for individuals with a track record in entrepreneurship, product management, or specialized domain expertise.</p></div>
            <div className="faq-card"><h3>Is this a <span>full-time</span> role?</h3><p>Most facilitator roles are part-time or project-based, designed to complement your primary professional work.</p></div>
            <div className="faq-card"><h3>How are workshops <span>structured?</span></h3><p>Workshops are hybrid modules — virtual lectures and interactive physical validation quests.</p></div>
            <div className="faq-card"><h3>Are facilitators <span>compensated?</span></h3><p>Yes. Facilitators receive premium professional honorariums per session or workshop module.</p></div>
          </div>
        </div>
      </section>
...
export default CareerFacilitator;
