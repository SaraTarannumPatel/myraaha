    ...
    <div className="space-y-8">
      ...
      >
        <div className="bg-gradient-to-br from-[hsl(270 96% 30%)] to-[hsl(270 96% 18%)] p-6 relative">
          <div className="absolute top-3 right-3 inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[hsl(48 92% 72%)]/20">
            <Sparkles size={10} className="text-[hsl(48 92% 72%)]" />
          ...
          <div className="flex items-center gap-4">
            <div className="w-20 h-20 rounded-2xl bg-[hsl(48 92% 72%)] flex items-center justify-center text-[hsl(270 96% 30%)] font-display text-3xl font-bold border-4 border-white/20">
              {initials}
            </div>
            <div className="flex-1">
              ...
              >
                <code className="font-mono text-sm font-bold text-[hsl(48 92% 72%)] tracking-wider">{uid}</code>
                {copied ? (
                  <Check size={14} className="text-[hsl(48 92% 72%)]" />
                ) : (
