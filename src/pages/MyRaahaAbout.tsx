  ...
  "Leadership team": [
    {
      ...
      journey:
        "Mainak leads the product strategy and platform architecture, ensuring a seamless navigation experience for every user. With an IIT background, he brings a structured approach to building scalable tech infrastructure.",
    ...
    },
    {
      ...
      journey:
        "Rishi brings deep fintech expertise to build self-sustaining, revenue-first models for social impact. He ensures that MyRaaha reaches rural India without being beholden to donation cycles.",
    ...
    },
    {
      ...
      journey:
        "Dr. Santosh spearheads the 3A Intelligence Engine, integrating advanced AI for personalized career guidance. His research focuses on making AI emotionally intelligent and accessible.",
  ...
  "Core team": [
    {
      ...
      journey:
        "Swati ensures our frameworks are aligned with the latest educational standards and pedagogical best practices. She bridges the gap between academic theory and industry demand.",
    ...
    },
    {
      ...
      journey:
        "Sara drives the core technology development, turning complex navigation logic into intuitive software. She is passionate about building tech that has a real-world social impact.",
    ...
    },
    {
      ...
      journey:
        "Popy manages the end-to-end business operations, scaling MyRaaha's reach to tier 3 and 4 cities. She ensures that our navigation system is accessible to everyone, everywhere.",
  ...
  "Domain specialists": [
    {
      ...
      journey:
        "Jovina builds and nurtures the growing team of innovators and volunteers that power the MyRaaha mission. She focuses on building a culture of radical autonomy and inclusion.",
    ...
    <div className="about-page">
      ...
      <section className="motivation-premium">
        <div className="motivation-hero">
          ...
          <div className="motivation-hero-content">
            ...
            <h2 className="motivation-hero-title">
              The world of work is <span>transforming</span>
            </h2>
            <p className="motivation-hero-lead">
              After extensive research, we found that newer economies and domains remain largely unexplored, creating a
              gap that MyRaaha is uniquely designed to fill.
            </p>
          </div>
        </div>
        ...
        <div className="compounding-effect-premium">
          <div className="compounding-header">
            ...
            <h3>
              Confusion magnified by the <span>compounding effect</span>
            </h3>
          </div>
      ...
      <section className="bharat-mission-premium">
        <div className="bharat-header">
          ...
          <h2 className="section-title">
            Bridging the <span>Bharat gap</span>
          </h2>
          <p className="section-subtitle">
            Fueling a $30 Tn economy through structural clarity and data-driven guidance.
          </p>
        </div>
        ...
        <div className="bharat-mosaic">
          ...
          <div className="mosaic-card challenge-card">
            ...
            <p className="challenge-lead">
              India's problem is not unemployment alone — it is <strong>"Mass non-participation"</strong> due to career
              misalignment.
            </p>
            <div className="lfpr-visual">
              <div className="lfpr-stat">
                ...
                <div className="stat-bar-bg">
                  <div className="stat-bar current" style={{ width: "55%" }}></div>
                </div>
              </div>
              <div className="lfpr-divider">
                <TrendingUp size={20} />
              </div>
              <div className="lfpr-stat">
                <div className="stat-info">
                ...
                <div className="stat-bar-bg">
                  <div className="stat-bar target" style={{ width: "70%" }}></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="value-realization-strip">
          <div className="strip-title">
            What quality guidance <span>offers</span>
          </div>
          <div className="offers-grid">
            <div className="offer-card">
              ...
              <div className="offer-info">
                <strong>Students</strong> <span>Choice clarity</span>
              </div>
            </div>
            <div className="offer-card">
              <div className="offer-icon">
              ...
              <div className="offer-info">
                <strong>Parents</strong> <span>Risk reduction</span>
              </div>
            </div>
            <div className="offer-card">
              <div className="offer-icon">
              ...
              <div className="offer-info">
                <strong>Schools</strong> <span>NEP compliance</span>
              </div>
            </div>
            <div className="offer-card">
              <div className="offer-icon">
              ...
              <div className="offer-info">
                <strong>Colleges</strong> <span>Better intake</span>
              </div>
            </div>
            <div className="offer-card">
              <div className="offer-icon">
              ...
              <div className="offer-info">
                <strong>Industry</strong> <span>Recruitable talent</span>
              </div>
            </div>
            <div className="offer-card">
              <div className="offer-icon">
              ...
              <div className="offer-info">
                <strong>CSR</strong> <span>Measurable impact</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="theory-premium-v7">
        <header className="theory-v7-header">
          ...
          <h2 className="section-title">
            The theory of <span>change</span>
          </h2>
        ...
        <div className="theory-v7-layer prism-layer">
          <div className="prism-container">
            <div className="prism-content">
              <div className="prism-icon-box">
                <Star size={32} />
              </div>
              <h3>
                The North <span>Star</span>
              </h3>
              <p className="prism-lead">
                To democratize career guidance for students and early professionals by combining human empathy and
                intelligent technology.
              </p>
              <div className="prism-mission">
                <p>
                  "Building the world's most empathetic career intelligence platform — where technology scales trust."
                </p>
              </div>
            </div>
        ...
        <div className="theory-v7-layer ecosystem-layer">
          <div className="layer-header">
            ...
            <h3>
              The <span>ecosystem</span> resources
            </h3>
          </div>
        ...
        <div className="theory-v7-layer engine-layer">
          <div className="layer-header">
            ...
            <h3>
              Intelligence <span>Architecture</span>
            </h3>
          </div>
          ...
          <div className="engine-blueprint">
            <p>
              Our "Career-GPS" combines <strong>Psychometric Depth</strong> with <strong>Economic Realities</strong> to
        ...
        <div className="theory-v7-layer hypothesis-layer">
          <div className="layer-header">
            ...
            <h3>
              Our <span>hypothesis</span>
            </h3>
          </div>
          <div className="ass-grid-v6">
            <div className="ass-card-v6">
              <p>
                Confusion is caused by <strong>lack of access</strong>, not lack of talent.
              </p>
            </div>
            <div className="ass-card-v6">
              <p>
                Human connection is essential — technology must <strong>scale empathy</strong>.
              </p>
            </div>
            <div className="ass-card-v6">
              <p>
                Real change happens when guidance is <strong>localized and experiential</strong>.
              </p>
            </div>
            <div className="ass-card-v6">
              <p>
                Sustainable models require <strong>multi-stakeholder participation</strong>.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="timeline-container">
          ...
          <div className="timeline-item">
            <div className="timeline-content">
              ...
              <p>
                Two colleagues, working together at a previous company, had spent months watching the same problem play
                out around them. Students picking careers by accident. Young professionals three years into the wrong
                job with no language to describe why it felt wrong.
              </p>
            </div>
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
              ...
              <h3>
                Architecture of <span>understanding</span>
              </h3>
              <p>
                Before any code was written, they mapped the problem with clinical obsession. They arrived at a core
                insight: this is not a talent gap—it is an infrastructure gap. The philosophical shape of MyRaaha formed
                here: non-profit by intent, revenue-first by design.
              </p>
            </div>
          </div>
          ...
          <div className="timeline-item">
            <div className="timeline-content">
              ...
              <p>
                The CEO called them honestly: no salary yet, no funding, but a mission that felt like it actually
                mattered. Engineers, designers, and researchers who had watched friends make terrible career choices
                joined the cause. What started as 2 became 13.
              </p>
            </div>
            <div className="timeline-dot">
              <span>03</span>
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
              ...
              <h3>
                Building what didn't <span>exist</span>
              </h3>
              <p>
                MyRaaha was creating an entirely new category. The 3A Intelligence Engine, The Living Resume™, and The
                SelfGraph™ took shape. ShuttlEx took shape here—not a quiz, but a living, breathing journey that evolved
                with every choice.
              </p>
            </div>
          </div>
          ...
          <div className="timeline-item">
            <div className="timeline-content">
              ...
              <h3>
                The hard <span>middle</span>
              </h3>
              <p>
                The quiet, unglamorous stretch. The architecture was defined, the team was assembled, but the product
                was not yet ready. The culture—no emotional theatrics, no hype—became the thing that kept momentum alive
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
              ...
              <h3>
                MyRaaha is <span>born</span>.
              </h3>
              <p>
                Eleven months after the first phone call, MyRaaha is born. A product designed not to inspire, but to
                navigate—with the kind of quiet, structural confidence that comes from building something you believe in
                completely.
              </p>
            </div>
          </div>
      ...
      <section className="about-section team-grid-section">
        <div className="section-header">
          ...
          <h2 className="section-title">
            The people behind the <span>mission</span>
          </h2>
          <p className="section-subtitle">
            A collective of dreamers and doers committed to scaling empathy and intelligence for Bharat's youth.
          </p>
        </div>
